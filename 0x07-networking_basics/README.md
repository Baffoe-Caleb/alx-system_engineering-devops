...
Project done during **Full Stack Software Engineering** studies at **ALX Africa**. It aims to learn about the OSI model, LAN, WAN, IP address, localhost, subnet and TCP/UDP. </br> In this project, I answered a few quiz-like questions and wrote a couple bash scripts.
